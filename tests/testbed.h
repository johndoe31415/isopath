...
#define abort_subtest_if_assertion_failure(msg, ...)	if (get_subtest_failure_count()) { fprintf(stderr, msg, ##__VA_ARGS__); subtest_finished(); return; }

/*************** AUTO GENERATED SECTION FOLLOWS ***************/
bool test_verbose(void);
void debug(const char *msg, ...);
int get_subtest_failure_count(void);
